        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor"
            >
              <img
                src={github}
                alt="github"
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          The following few projects exemplify my expertise and experience by
